...
const TRANSLATIONS = {
  ...
  // The player: the queue, the playlists, the equaliser, the listens
  "Плейлисты": "Playlists",
  "Новый плейлист": "New playlist",
  "Новый плейлист…": "New playlist…",
  "Сохранить как плейлист": "Save as a playlist",
  "Плеер": "Player",
  "Как звучит музыка и кто узнаёт, что вы слушаете": "How the music sounds, and who hears what you play",
  "Альбомы без пауз": "Albums without gaps",
  "Следующий трек альбома начинается ровно там, где кончился предыдущий. Концертные записи и альбомы, где песни перетекают одна в другую, звучат как на диске": "The next track of an album starts exactly where the last one ended. Live recordings and albums whose songs run into each other sound as they do on the record",
  "Плавный переход": "Crossfade",
  "Конец трека затихает, пока начинается следующий. Альбом, который играет по порядку, идёт без перехода": "A track's end fades out while the next one begins. An album played in its own order goes on without it",
  "Эквалайзер": "Equalizer",
  "Эквалайзер включён": "Equalizer on",
  "Настроить…": "Adjust…",
  "Настройка": "Preset",
  "Подключить": "Connect",
  ...
  "Открыть альбом": "Open the album",
  "Убрать из плейлиста": "Remove from playlist",
  "Открыть плейлист .m3u8 из другого плеера": "Open an .m3u8 playlist from another player",
  "Открыть плейлист .m3u8": "Open an .m3u8 playlist",
  "Слушать вперемешку": "Play shuffled",
  "Переименовать": "Rename",
  "Сохранить как .m3u8 для других плееров": "Save as .m3u8 for other players",
  "Сохранить как .m3u8": "Save as .m3u8",
  "Удалить плейлист": "Delete playlist",
  "Токен из настроек профиля": "Token from your profile settings",
  "Токен ListenBrainz": "ListenBrainz token",
  "Очередь (Q)": "Queue (Q)",
  "Сохранить очередь как плейлист": "Save the queue as a playlist",
  "Убрать всё, что дальше": "Clear what comes next",
  "Закрыть (Esc)": "Close (Esc)",
  "Закрыть": "Close",
  "Действия с треком": "Track actions",
  "В какой плейлист": "Which playlist",
  "Читаем плейлисты…": "Reading the playlists…",
  "Плейлистов пока нет": "No playlists yet",
  "Создайте свой или добавьте треки правым щелчком: «Добавить в плейлист». Плейлист .m3u8 из другого плеера тоже подойдёт": "Make one, or right-click tracks and choose \"Add to playlist\". An .m3u8 playlist from another player works too",
  "{hertz} Гц": "{hertz} Hz",
  "Своя": "Custom",
  "своя": "custom",
  "Включён: {preset}": "On: {preset}",
  "Выключен": "Off",
  "Очередь от {date}": "Queue of {date}",
  "Убрать из очереди": "Remove from queue",
  "дальше {count} {trackWord}": "{count} {trackWord} to come",
  "дальше ничего": "nothing to come",
  "Альбома этого трека нет в библиотеке": "This track's album is not in the library",
  "Создать": "Create",
  "Плейлист «{name}»: {count}": "Playlist \"{name}\": {count}",
  "Плейлист {number}": "Playlist {number}",
  "Плейлист": "Playlist",
  "Сохранено: {path}": "Saved: {path}",
  "Название плейлиста": "Playlist name",
  "Удалить плейлист «{name}»?": "Delete the playlist \"{name}\"?",
  "Сами треки останутся в библиотеке": "The tracks themselves stay in the library",
  "Добавлено в «{name}»: {count}": "Added to \"{name}\": {count}",
  "{seconds} с": "{seconds} s",
  "нет": "off",
  " · ждут отправки: {count}": " · waiting to be sent: {count}",
  "Прослушивания уходят в профиль {name}": "Listens go to the profile {name}",
  "Отправляет прослушанные треки в ваш профиль Last.fm. Подключение откроет страницу Last.fm, где нужно разрешить доступ": "Sends the tracks you listen to to your Last.fm profile. Connecting opens Last.fm's page, where you allow access",
  "Открытая замена Last.fm. Токен — на странице listenbrainz.org/settings": "The open alternative to Last.fm. The token is on listenbrainz.org/settings",
  "Жду разрешения на Last.fm…": "Waiting for Last.fm…",
  "Last.fm подключён: {name}": "Last.fm connected: {name}",
  "ListenBrainz подключён: {name}": "ListenBrainz connected: {name}",
  "по прослушиваниям": "by plays",
  "по изменению": "by last change",
  "Ровно": "Flat",
  "Больше баса": "More bass",
  "Больше высоких": "More treble",
  "Голос": "Vocal",
  "Рок": "Rock",
  "Электроника": "Electronic",
  "Акустика": "Acoustic",
  "Тихо, но разборчиво": "Quiet but clear",
  "«{title}» заиграет следующим": "\"{title}\" plays next",
  "«{title}» в очереди": "\"{title}\" is in the queue",
  "Заиграют следующими: {count}": "Playing next: {count}",
  "По последнему прослушиванию": "Latest first",
  ...
  "Здесь появятся треки, когда вы их послушаете": "Tracks show up here once you have listened to them",
  "Пока пусто. Треки добавляются правым щелчком в альбоме, во вкладке «Треки» или в библиотеке": "Empty for now. Tracks are added with a right click on an album's page, in the Tracks tab or in the library",
};

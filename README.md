...
**Настройки** — тема (как в системе, светлая или тёмная), сколько треков качать одновременно и проверка, установлены ли ffmpeg и Deno/Node.js. Настройки хранятся в `%USERPROFILE%\.trackhound.json`.

...
Слева — разделы: Загрузка, Библиотека, Очередь и Настройки (Ctrl+1…4). Кнопка над ними разворачивает панель с подписями и сворачивает обратно (Ctrl+B); выбранное состояние запоминается.
